...
<Tabbar tabType="tertiary" tabContent="modelReviewTab" tab="newcommits" />
<div class="px-12 pt-8 w-full h-[75%] overflow-auto">
  <div class="w-2/3">
    <form method="post">
      ...
      <a
        href="/org/pureml/models/churn/review/123/logs"
        type="submit"
        class="pb-6 w-full"
      >
        <div
        ...
        >
          <div class="flex items-center">
            ...
            <div class="text-left text-sm text-slate-600 px-4">
              <a
                href="/org/pureml/models/churn/review"
              ...
              <a href="/" class="font-medium text-slate-800">
                <!-- href={`/org/${reviewData.params.orgId}/models/${review.model.name}`} -->
                "review.model.name"
              </a>{" "}
